...
namespace ReMod.Core.UI.QuickMenu
{
    ...
    public class ReMenuCategory : IButtonPage
    {
        ...
        {
            var button = new ReMenuButton(text, tooltip, onClick, _buttonContainer.RectTransform, sprite, full);
            return button;
        }
        ...
        {
            var toggle = new ReMenuToggle(text, tooltip, (Action<bool>)Action.Combine(configValue.SetValue, action), _buttonContainer.RectTransform, configValue, iconOn, iconOff);
            return toggle;
        }
